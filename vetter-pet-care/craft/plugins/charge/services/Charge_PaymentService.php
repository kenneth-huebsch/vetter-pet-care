...
class Charge_PaymentService extends BaseApplicationComponent
{
    ...
    public function recordPaymentFromInvoicePayment($paymentDetails)
    {
        ...
        if ($subscription != null) {
            ...
            if (isset($paymentDetails['period_start']) && isset($paymentDetails['period_end'])) {
                ...
                craft()->charge_subscription->refreshSubscriptionRecord($subscription);
            }
        }
    ...
    public function findPaymentByCustomerId($stripePaymentId)
    {
        $model = Charge_PaymentRecord::model()->findByAttributes(['customerId' => $stripePaymentId]);
