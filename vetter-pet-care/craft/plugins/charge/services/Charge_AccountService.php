...
class Charge_AccountService extends BaseApplicationComponent
{
    public function saveAccount(Charge_AccountModel $account)
    {
        ...
        $accountRecord->elementId = $account->elementId;
        ...
        /**
         * Gets an account by the id
         *
         * @param int $id
         *
         * @return Charge_AccountModel|null
         */
        public function getAccountbyId($id)
        {
            $record = $this->_getAccountRecordById($id);

            return Charge_AccountModel::populateModel($record);
        }
