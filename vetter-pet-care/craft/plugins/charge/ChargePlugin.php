...
class ChargePlugin extends BasePlugin
{
    ...
    {
        return 'https://transition.topshelfcraft.com/software/craft/charge';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/TopShelfCraft/Release-Feeds/master/Charge.json';
    }
    ...
    public function registerCpRoutes()
    {
        return [
            ...
            'charge/connect/(?P<accountId>\d+)'                     => ['action' => 'charge/connect/view'],
            ...
            'charge/settings/compatibility'                         => ['action' => 'charge/compatibility/index'],
            'charge/appointments'                                   => ['action' => 'charge/appointments/view'],
            'charge/appointments/process/(?P<apptId>\d+)'           => ['action' => 'charge/appointments/process'],
            'charge/appointments/viewProcessed/(?P<apptId>\d+)'     => ['action' => 'charge/appointments/viewProcessed'],
            'charge/appointments/processed'                         => ['action' => 'charge/appointments/processed'],
            'charge/oneoffbilling'                                  => ['action' => 'charge/oneoffbilling'],
    ...
    public function prepCpTemplate(&$context)
    {
        ...
        if (craft()->userSession->isAdmin() || $user->can('accessPlugin-charge')) {
            ...
            $context['subnav']['appointments'] = ['label' => Craft::t('Appointments'), 'url' => 'charge/appointments'];
            $context['subnav']['processed'] = ['label' => Craft::t('Processed'), 'url' => 'charge/appointments/processed'];
            /* Add one-off billing page */
            $context['subnav']['oneoffbilling'] = ['label' => Craft::t('One-off billing'), 'url' => 'charge/oneoffbilling'];
        }
    }
    ...
    public function prepCpSettingsTemplate(&$context)
    {
        ...
        $context['navItems']['compatibility'] = ['title' => Craft::t('Compatibility')];
    ...
    /*
    // @todo - add this back in later with proper implementation
