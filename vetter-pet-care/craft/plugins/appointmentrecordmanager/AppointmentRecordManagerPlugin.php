 ...
 * @copyright Copyright (c) 2019 Kenneth Huebsch
...
class AppointmentRecordManagerPlugin extends BasePlugin
{
    /**
    ...
    {
         return Craft::t('Appointment Record Manager');
    }
    ...
    {
        return Craft::t('This plugin facilitates simple tasks from the Appointment Record page.');
    }
    ...
    {
        return 'https://github.com/N/A/appointmentrecordmanager/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/N/A/appointmentrecordmanager/master/releases.json';
    }
